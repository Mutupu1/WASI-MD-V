...
global.allowJids = process.env.ALLOW_JID || "263783658393@s.whatsapp.net";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-Mutupu1-𝐌𝐃-𝐕2😍",
  author: process.env.PACK_AUTHER || "WASO",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "Mutupister-𝐌𝐃-𝐕2",
  ownername: process.env.OWNER_NAME || "Mutupu1",
